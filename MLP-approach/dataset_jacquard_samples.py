...
#jacquard_root  = os.getcwd()+ r'/data/categories_mlp_1training_sample/categories/' ##for small subsets
jacquard_root = os.getcwd()+ r'/Dataset/categories/' ##for whole dataset
